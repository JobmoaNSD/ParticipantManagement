                                    ...
                                    <div class="row default-card-body">
                                        ...
                                        <div class="col-md-1" style="width: 11%">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control datepicker_on" id="basicDob" name="basicDob" placeholder="yyyy-mm-dd" aria-label="생년월일" value="${basic.basicDob}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-1 w-auto">
                                            ...
                                            <input type="text" class="form-control" id="basicAddress" name="basicAddress" value="${basic.basicAddress}">
                                        </div>
                                        <div class="col-md-1 w-auto">
